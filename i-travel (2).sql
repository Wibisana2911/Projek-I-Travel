...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Des 2022 pada 06.00
...
INSERT INTO `hargas` (`id`, `id_tiket`, `harga`, `promo`, `created_at`, `updated_at`) VALUES
(1, 10000, 150000, 100000, NULL, NULL);
...
INSERT INTO `reviews` (`id`, `id_user`, `deskripsi`, `date`, `created_at`, `updated_at`) VALUES
(1, 1, 'lorem ipsum', '2022-12-29 11:45:55', NULL, NULL),
(2, 7, 'lorem ipsum', '2022-12-29 12:06:40', NULL, NULL),
(3, 1, 'ini komentar', '2022-12-29 12:07:24', NULL, NULL),
(8, 8, 'ini komentar', '2022-12-29 12:29:31', '2022-12-28 20:29:31', '2022-12-28 20:29:31');
...
(3, 'admin1', 'admin1@gmail.com', NULL, '$2y$10$kMiBH/GT4UNCUQKkJfymp.JDFdBUh6I9fkMeTJhcvC1zr4ZR.Ab8u', 'admin', 'O91SDikWxzJpi1Gx2OSpmHwHnwAmE0xP4kTNEDAHUTXmvYfdds3buHHTiIuE', '2022-12-25 19:29:18', '2022-12-25 19:29:18'),
...
(8, 'Uwu', 'uwu1@gmail.com', NULL, '$2y$10$iEaQUxI6.2KwjP07bSNgIOa5DGY3hsuaEtsbe2DmNCWfpqrPuqHP6', 'user', NULL, '2022-12-28 20:22:21', '2022-12-28 20:22:21');
...
(1002, 2, 'Garuda-Wisnu-Kencana', 'Garuda Wisnu Kencana', 'Taman Budaya Garuda Wisnu Kencana merupakan sebuah icon spesial untuk bali dan juga untuk Indonesia ', 'Badung, Bali', '2022-12-17', NULL, NULL);
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `fk_review_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
