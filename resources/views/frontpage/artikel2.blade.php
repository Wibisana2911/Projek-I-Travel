    ...
    <main class="w-full h-full">
        <div class="pt-20 ml-80 md:max-w-3xl protected">
            <div class="w-full px-4 text-xl leading-normal text-gray-800 md:px-6" style="font-family:Georgia,serif;">
                <div class="font-sans">
                    <h1 class="pt-6 pb-2 font-sans text-3xl font-bold text-gray-900 break-normal md:text-4xl">Pantai Pandawa Bali, Pantai Rahasia Yang Penuh Pesona</h1>
                    <img src="/img/Pantai Pandawa.jpg" alt="" width="100%">
                </div>
                <div class="justify-center text-justify">
                <a class="text-green-500 no-underline hover:underline ml-12" href="https://www.tailwindcss.com"></a> Pantai Pandawa ini berlokasi di area Kuta Selatan, Kabupaten Badung, Bali. Pantai ini terletak di balik perbukitan yang sering di sebut oleh orang lokal Kuta sebagai Pantai Rahasia. Hal ini dikarenakan lokasinya yang sedikit tersembunyi dan perlu berjalan sedikit lebih jauh untuk sampai ke Pantai Rahasia.
                </div>

                <!--Start Info-->
                <div class="py-6 justify-center text-justify">
                    <strong><p class="text-2xl shadow-black"> Aktivitas Menarik Yang Dapat Kamu Lakukan di Pantai Pandawa</p></strong>
                    <p> Berikut ini beberapa aktivitas menarik yang dapat kamu coba selagi berada di Pantai Pandawa.
                        <!-- info1 -->
                        <div>1.  Bermain Dengan Kano
                            <img src="/img/Bermain dengan kano.jpg" alt="" class="ml-10" width="680pt">
                        </div>
                        <div class="py-6 ml-12">
                            <a class="ml-12">Kano adalah sebuah perahu kecil yang disediakan untuk bermain di laut sambil menikmati pemandangan
                                di bawah laut. Petugas pantai juga menyediakan pelampung sebagai bentuk pengamanan agar wisatawan tidak
                                tenggelam.
                            </a>
                        </div>

                        <!-- info2 -->
                        <div>2.  Bersantai Di Pinggir Pantai
                            <img src="/img/Bersantai Di Pinggir Pantai.jpg" alt="" class="ml-10" width="680pt">
                        </div>
                        <div class="py-6 ml-12">
                            <a class="ml-12">Bagi sebagian orang yang datang berkunjung, ingin menikmati suasana pantai dibawah sinar matahari sambil
                                berjemur. Tentu saja, pantai ini menyediakan payung yang berjejer di pinggir pantai untuk pengunjung yang ingin
                                berjemur. Namun, tetap dikenakan biaya sewa sebesar Rp. 50.000 untuk payung dan kursi santai selama 3 jam.
                            </a>
                        </div>
                        ...
                        <div class="py-6 ml-12">
                            <a class="ml-12">Bagi kamu yang gemar berselancar dengan ombak, maka Pantai Pandawa merupakan pilihan yang tepat. Pantai
                                ini memiliki ombak yang cocok untuk berselancar atau surfing. Gulungan ombak yang tinggi dan konsisten sudah
                                menjadi favorit bagi peselancar yang datang terutama bagi turis asing.
                            </a>
                        </div>

                        <!-- info4 -->
                        <div>4. Bermain Paragliding
                            <img src="/img/Paragliding.jpg" alt="" class="ml-10" width="680pt">
                        </div>
                        <div class="py-6 ml-12">
                            <a class="ml-12">Untuk kegiatan yang lebih menguji adrenaline, kamu bisa mencoba paragliding dan menikmati pemandangan
                                Pantai Pandawa dari atas. Karena disekitar pantai terdapat tebing dan didukung oleh hembusan angin yang sejuk,
                                menyempurnakan bagi pengunjung yang ingin menikmati suasana Pantai dari atas.
                            </a>
                        </div>
                </div>
