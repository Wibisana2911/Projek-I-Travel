...
<<<<<<< HEAD
  ...
  <!--Header-->
<body class="font-mono leading-normal tracking-normal text-white bg-gray-900 bg-gradient dark:bg-gray-800" style="font-family: 'Source Sans Pro', sans-serif;">

    <!--Nav-->
    <nav id="header" class="fixed top-0 z-30 w-full text-white dark:text-black">
...
<<<<<<< HEAD
        <div class="z-20 flex-grow hidden w-full p-4 mt-2 text-black bg-white dark:bg-gray-800 lg:flex lg:items-center lg:w-auto lg:mt-0 lg:bg-transparent lg:p-0" id="nav-content">
          <ul class="items-center justify-end flex-1 list-reset lg:flex">
            ...
            <li class="mr-3">
              <a class="inline-block px-4 py-2 text-black  dark:text-white  dark:text-whiteno-underline hover:rounded-full hover:bg-teal-400 hover:text-xl hover:font-semibold" href="/wisata">WISATA</a>
            </li>
            <li class="mr-3">
...
>>>>>>> 44a1f7ab0c4b64ba15f6406acd34bf8a568932d1
            ...
            <dh-component>
                <div class="container flex justify-center pt-16 mx-auto">
                    <div>
                        <p class="pb-3 text-lg font-normal text-center text-white">BUILDING TEAM</p>
...
>>>>>>> 44a1f7ab0c4b64ba15f6406acd34bf8a568932d1
                                    <div class="px-6 mt-16">
                                        ...
                                        <p class="text-sm text-center text-gray-800 hover:font-extrabold">Backpage Developer</p>
                                        <p class="pt-3 text-base font-normal text-center text-gray-600">Mahasiswa Ilmu Komputer Undiksha Semester III, Sebagai Salah Satu Author Pembuatan Projek Akhir Mata-Kuliah Teknologi Web Dengan Judul I-Travel</p>
                                        <div class="flex justify-center w-full pt-5 pb-5">
                                          <a href="javascript:void(0)" class="mx-5 hover:rounded-full hover:p-1 hover:bg-white">
...
>>>>>>> 44a1f7ab0c4b64ba15f6406acd34bf8a568932d1
                                  <div class="px-6 mt-16">
                                        ...
                                        <p class="text-sm text-center text-gray-800 hover:font-extrabold">Frontpage Developer</p>
                                        <p class="pt-3 h-36 text-base font-normal text-center text-gray-600">Mahasiswa Ilmu Komputer Undiksha Semester III, Sebagai Salah Satu Author Pembuatan Projek Akhir Mata-Kuliah Teknologi Web Dengan Judul I-Travel</p>
                                        <div class="flex justify-center w-full pt-5 pb-5">
                                            <a href="javascript:void(0)" class="mx-5 hover:rounded-full hover:p-1 hover:bg-white">
                                                <div aria-label="Github" role="img">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
...
<div id="accordion-collapse" data-accordion="collapse">
  <h2 id="accordion-collapse-heading-1">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-900 bg-gray-100 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-t-xl" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
    <span>What is I-Travel?</span>
    <svg data-accordion-icon class="w-6 h-6 rotate-180 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
  </button>
  </h2>
  <div id="accordion-collapse-body-1" aria-labelledby="accordion-collapse-heading-1">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
      <p class="mb-2 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet neque, facere dignissimos dolorum molestiae totam quos dolorem, perspiciatis voluptates nihil fugiat eius suscipit. Eveniet aliquid, adipisci quo voluptatem quasi ipsa!</p>
  ...
  <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dicta perspiciatis minima nihil rerum quasi, perferendis optio sit fuga tenetur laudantium voluptates cum, molestias veritatis animi, eius aspernatur sed quia et!</p>
  ...
  <h2 id="accordion-collapse-heading-3">
    ...
    <span>What is historical of I-Travel?</span>
    <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
  </button>
  </h2>
  <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
    <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur quis quaerat unde consequatur totam beatae reprehenderit neque mollitia alias corporis hic rerum laboriosam voluptates, veritatis quasi repudiandae dolor? Officia, magni.</p>
