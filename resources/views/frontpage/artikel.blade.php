    ...
    <main class="w-full h-full">
        <div class="pt-20 ml-80 md:max-w-3xl protected">
            <div class="w-full px-4 text-xl leading-normal text-gray-800 md:px-6" style="font-family:Georgia,serif;">
                <div class="font-sans">
                    <h1 class="pt-6 pb-2 font-sans text-3xl font-bold text-gray-900 break-normal md:text-4xl">Keindahan Pantai Dreamland</h1>
                ...
                <div class="py-6 justify-center text-justify">
                    ...
                    <p> Berikut beberapa aktivitas seru yang bisa Anda lakukan saat berwisata ke Pantai Dreamland Bali.
                        <!-- info1 -->
                        <div>1.  Menikmati Pemandangan Pantai Dreamland
                            <img src="/img/Pemandangan Pantai.jpg" alt="" class="ml-10" width="680pt">
                        </div>
                        <div class="py-6 ml-12">
                            <a class="ml-12">Ada banyak spot yang bisa dijadikan lokasi menikmati pemandangan. Misalnya dengan menyewa tempat duduk
                                yang memiliki payung di atasnya yang berada di sekitar bibir pantai. Anda bisa menyewanya sepanjang hari dan
                                menikmati suasana pantai dari sana.
                            </a>
                        </div>

                        <!-- info2 -->
                        <div>2.  Menikmati Sunset Pantai Dreamland
