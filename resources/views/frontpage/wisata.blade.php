...
<<<<<<< HEAD
  <div class="grid grid-cols-1 gap-5 p-10 mt-20 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 bg-gray-900">
    ...
    @foreach($Wisata as $w)
    <!--Card-->
    <div class="overflow-hidden rounded shadow-lg bg-gray-100 dark:bg-gray-700">
      <a href="/{{$w->nama_wisata}}"><img class="w-screen h-72" src="/img/{{$w->gambar}}.jpg" alt="Gambar"></a>
      <div class="px-6 py-4">
